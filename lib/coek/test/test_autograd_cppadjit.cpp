...
TEST_CASE("cppadjit_add", "[smoke]")
{
    SECTION("error1")
    {
        ...
        coek::NLPModel nlp;
        REQUIRE_THROWS_WITH(
            nlp.initialize(model, "cppad_jit"),
...
TEST_CASE("cppadjit_ad", "[smoke]")
{
    SECTION("f")
    {
        ...
        coek::NLPModel nlp(model, "cppad_jit");
    ...
    SECTION("dense_j")
    {
        WHEN("nx < nc")
        {
            ...
            coek::NLPModel nlp(model, "cppad_jit", false);
...
TEST_CASE("cppadjit_diff_tests", "[smoke]")
{
